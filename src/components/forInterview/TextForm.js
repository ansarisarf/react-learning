...
export default function TextForm(props) {
    ...
    return (
        <div className="container-fluid" style = {{color: props.mode === 'dark' ? 'white' : '#042742'}}>
                ...
                <div className="col-lg-12">
                    <div className="card shadow mb-4">
                        ...
                        <div className="card-body">
                            <div className="mb-3">
                                <textarea className="form-control" style={{ backgroundColor: props.mode==='dark'?'#13466e':'white', color: props.mode==='dark'?'white':'#042742' }} id="mybox" value={text} onChange={handleOnChange} rows="5" placeholder="Enter text here......."></textarea>
                            </div>
            ...
            <div className="row" style = {{color: props.mode === 'dark' ? 'white' : '#042742'}}>
                <div className="col-lg-12">
                    <div className="card mb-4">
                        <div className="card-header py-3">
                            <h6 className="m-0 font-weight-bold text-primary">Text Summery</h6>
                        </div>
                        <div className="card-body">
                            <div className="row">
                                ...
                                <div className="col-lg-12">
                                        <div class="card mb-4 py-3 border-left-info">
                                            <div className="card-header py-3">
                                                <h6 className="m-0 font-weight-bold text-primary">Preview</h6>
                                            </div>
                                            <div class="card-body">
