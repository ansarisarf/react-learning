                ...
                <div className="col-lg-6">
                    <div className="card shadow mb-4">
                        <div class = "card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 className="m-0 font-weight-bold text-primary">Using Functional Component</h6>
                        </div>
                        <div className="card-body">
                            ...
                            <button className="btn btn-secondary mx-1" type="button"> Count: {count} </button> 
                ...
                <div className="col-lg-6">
                    <div className="card shadow mb-4">
                        <div className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 className="m-0 font-weight-bold text-primary">Using Class Component</h6>
                        </div>
                        <div className="card-body">
                            <CounterClass/>
                        </div>
